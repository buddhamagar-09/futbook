        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-8">
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition"
                ></textarea>
            </div>
