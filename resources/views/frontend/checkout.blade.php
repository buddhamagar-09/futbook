...
<div class="min-h-screen bg-slate-50">
    ...
    <section class="py-10">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <!-- LEFT SIDE -->
                <!-- ================================= -->
                <form action="" method="post" id="checkoutform" class="grid grid-cols-1 gap-8 lg:grid-cols-3" >
                  @csrf
                                ...
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea id="address" rows="3"
                                            placeholder="Enter your complete delivery address" name="shipping_address"
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea id="order_note" rows="3" name="note"
                            ...
                            <div class="border-t border-slate-200 p-6">
                                ...
                                <div class="mt-5 flex items-start gap-3 border-t border-slate-100 pt-5">
                                    ...
                                    <p class="text-xs leading-5 text-slate-500">
                                        Your information is securely handled and will only be used to process your
                                        order.
                                    </p>
...
<script>
    document.getElementById('placeorderbtn').addEventListener('click', () => {
        ...
        if (selectedpayment === 'esewa') {
            ...
            form.action = "{{ route('esewa.initiatepayment') }}";
            form.method = "POST";
            ...
            if (confirm('Are you sure you want to place the order with Cash on Delivery?')) {
                ...
                form.action = "{{ route('cod.placeorder') }}";
                form.method = "POST";
