<header class="sticky top-0 z-50 border-b border-white/10 bg-slate-950/40 backdrop-blur">
    <div class="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4 lg:px-8">
        <a href="{{ url('/') }}" class="flex shrink-0 items-center gap-3 text-lg font-semibold tracking-tight">
        ...
        <nav class="hidden items-center gap-6 text-sm text-slate-300 lg:flex">
            ...
            <a href="#products" class="transition hover:text-white">New Arrivals</a>
            <a href="#products" class="transition hover:text-white">Sale</a>
        ...
        <div class="flex items-center gap-3 text-sm font-medium">
            <button
                type="button"
                class="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 p-2.5 text-white transition hover:bg-white/10"
                aria-label="Search"
            >
            ...
            @if(Auth::check())
                <span class="hidden items-center rounded-full border border-white/15 bg-white/10 px-3 py-2 text-sm font-medium text-white shadow-sm sm:inline-flex">
